...
export const determineContainerProps = props => {
  const { imgNode, config = {}, imgNodeWidth, imgNodeHeight, imgNodeRatio, params, size, doNotReplaceImageUrl } = props;
  ...
  return { sizes, ratio, width, height, doNotReplaceImageUrl };
};
